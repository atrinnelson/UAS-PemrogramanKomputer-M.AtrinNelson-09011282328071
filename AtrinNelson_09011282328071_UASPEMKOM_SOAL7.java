...
public class AtrinNelson_09011282328071_UASPEMKOM_SOAL7 {
    public static void main(String[] args) {
        Buku buku1 = new Buku("The Great Gatsby", "F. Scott Fitzgerald", 1925);
        Buku buku2 = new Buku("To Kill a Mockingbird", "Harper Lee", 1960);
